...
- altcoins
layout: post
description: Descubre qué es EOS, el llamado Ethereum Killer, cómo funciona su sistema operativo para dApps, su Delegated Proof of Stake y por qué recaudó 185 millones en su ICO.
...
faq:
  - question: "¿Qué es EOS?"
    answer: "EOS es una plataforma descentralizada de contratos inteligentes diseñada para actuar como un sistema operativo para aplicaciones descentralizadas (dApps), con capacidad para procesar miles de transacciones por segundo."
  - question: "¿Qué es el Delegated Proof of Stake de EOS?"
    answer: "En el modelo dPOS de EOS, los poseedores de tokens votan para elegir un número reducido de productores de bloques que validan las transacciones, lo que aumenta la velocidad pero reduce la descentralización."
  - question: "¿Cuál es la diferencia entre EOS y Ethereum?"
    answer: "EOS ofrece mayor velocidad de transacciones y no tiene tasas de gas, pero es menos descentralizado que Ethereum. El uso del ancho de banda en EOS es proporcional a los tokens que posee cada usuario."
  - question: "¿Cómo se financian los nodos en EOS?"
    answer: "Los productores de bloques en EOS son recompensados con nuevos tokens EOS en una cantidad variable decidida por la gobernanza de la red."
---
