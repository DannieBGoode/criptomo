...
faq:
  - question: "What is Solana and how does it differ from other blockchains?"
    answer: "Solana is an open-source blockchain designed to be fast and scalable. Its main differentiator is the Proof of History (PoH) consensus mechanism, which allows it to process thousands of transactions per second with very low fees."
  - question: "What is Solana's Proof of History?"
    answer: "Proof of History is a mechanism that cryptographically records events in time, allowing Solana's nodes to agree on the order of transactions efficiently without constantly communicating with each other."
  - question: "What is Solana used for?"
    answer: "Solana is primarily used for DeFi applications, decentralised exchanges (DEXs), NFT marketplaces, and other dApps that require many fast, low-cost transactions."
  - question: "What are Solana's limitations?"
    answer: "As a relatively recent platform, it may have less proven security than older blockchains. It is also subject to the regulatory and adoption challenges common across the DeFi sector."
---
