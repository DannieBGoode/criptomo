...
- altcoins
layout: post
description: Descubre qué es NEM (XEM) o New Economy Movement, la solución blockchain empresarial con Proof of Importance, mosaicos y namespaces. Tecnología, equipo y casos de uso.
banner_image: 201804/nem.png
lang: es
faq:
  - question: "¿Qué es NEM (XEM)?"
    answer: "NEM (New Economy Movement) es una plataforma blockchain empresarial lanzada en 2015 que permite a empresas gestionar activos digitales mediante un sistema de API. Su token nativo es XEM y está desarrollada por una fundación sin ánimo de lucro con sede en Singapur."
  - question: "¿Qué es Proof of Importance en NEM?"
    answer: "Proof of Importance (PoI) es el algoritmo de consenso propio de NEM. En lugar de recompensar a quien más potencia computacional o tokens acumule, valora la actividad real en la red, como el volumen de transacciones realizadas en los últimos 30 días y el tiempo que los fondos llevan en la cuenta."
  - question: "¿En qué se diferencian los smart contracts de NEM respecto a Ethereum?"
    answer: "En Ethereum los smart contracts residen directamente en el blockchain y son inmutables una vez desplegados. En NEM los contratos pueden ejecutarse en servidores propios de las empresas y solo se registra el resultado en el blockchain, lo que permite modificarlos o corregir errores pero requiere confiar en la entidad que los gestiona."
  - question: "¿Qué son los mosaicos en NEM?"
    answer: "Los mosaicos son activos digitales de la red NEM que pueden representar cualquier tipo de valor, como monedas, acciones, puntos de fidelización o contratos. Cada mosaico tiene propiedades configurables como nombre, cantidad y restricciones de transferibilidad."
---
