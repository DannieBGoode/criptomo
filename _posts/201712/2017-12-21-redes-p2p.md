...
- bitcoin
layout: post
description: Aprende cómo funcionan las redes P2P en Bitcoin, qué es el bootstrapping y cómo los nodos se conectan y protegen la red de ataques DDoS y envenenamiento.
banner_image: 201712/bitcoin_p2p.png
author: david
lang: es
faq:
  - question: "¿Qué es una red P2P y cómo funciona en Bitcoin?"
    answer: "Una red P2P (peer-to-peer) es una red donde cada nodo actúa simultáneamente como cliente y servidor, permitiendo el intercambio directo de información sin un servidor central. Bitcoin utiliza este modelo para gestionar y distribuir el blockchain de forma descentralizada."
  - question: "¿Qué es el bootstrapping en Bitcoin?"
    answer: "El bootstrapping es el proceso por el cual un nodo nuevo recaba las direcciones IP de otros nodos para unirse a la red. Bitcoin usa métodos como DNS seeding, address seeding e IRC seeding para que un cliente nuevo pueda encontrar peers activos."
  - question: "¿Cuáles son los principales ataques a una red P2P como Bitcoin?"
    answer: "Los dos ataques más comunes son el DDoS, donde se sobrecarga la red con mensajes masivos, y el envenenamiento de la red, donde un atacante comparte información falsa. Bitcoin usa Proof of Work para protegerse del envenenamiento de datos."
  - question: "¿Por qué Bitcoin no necesita un servidor central para funcionar?"
    answer: "Porque cada nodo de la red almacena una copia del blockchain y puede procesar transacciones de forma independiente. Basta con que exista un solo nodo activo para que la red pueda seguir operando."
---
