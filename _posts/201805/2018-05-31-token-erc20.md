...
- altcoins
layout: post
description: Descubre qué es un token ERC-20, cómo funciona el estándar de Ethereum, por qué facilita la creación de criptomonedas y en qué se diferencia de una altcoin.
