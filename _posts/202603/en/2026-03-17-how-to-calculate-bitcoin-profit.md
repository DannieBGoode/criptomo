---
title: "How to Calculate Bitcoin and Crypto Profit (Formula + Examples)"
...
popular: false
faq:
  - question: "What is the formula for calculating crypto profit?"
    answer: "The basic formula is: (Current Price - Purchase Price) x Coins held = Profit in dollars. To get the percentage return, divide the profit by your initial investment and multiply by 100."
  - question: "How do I calculate profit if I bought crypto at different times?"
    answer: "Calculate each purchase separately using its own buy price and quantity, then add the results together. You can also use a DCA calculator for periodic investments."
  - question: "Do I need to pay tax on crypto profits?"
    answer: "In most countries, yes. Crypto profits are typically taxed as capital gains. Rules vary by country, so consult a local tax advisor for your specific situation."
  - question: "What is the difference between profit and ROI in crypto?"
    answer: "Profit is the absolute gain in dollars. ROI (Return on Investment) is the percentage gain relative to your initial investment. ROI is useful for comparing different investments of different sizes."
  - question: "Does the calculator on this site account for fees?"
...
If you would rather skip the manual calculation, our [Bitcoin profit calculator](/en/calculator/) handles it instantly. Enter the purchase price, the current price, and the amount invested, and you get the result right away.
