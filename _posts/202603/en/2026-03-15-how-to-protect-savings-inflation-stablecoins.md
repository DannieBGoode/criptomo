---
title: "How to Protect Your Savings from Inflation with Stablecoins"
tags:
  - stablecoins
  - altcoins
layout: post
...
faq:
  - question: "Is it legal to hold stablecoins as savings in my country?"
    answer: "In most countries, buying and holding stablecoins is legal. You should check local tax rules — in many jurisdictions you must declare capital gains if you sell at a profit. Always consult a local tax advisor for your specific situation."
  - question: "What happens if Tether or Circle goes bankrupt?"
    answer: "If the issuer could not cover its reserves, the stablecoin could lose its peg. This is why USDC is recommended for savings — it has stronger audits and reserve transparency. Never store more than you are prepared to lose."
  - question: "Is it better to keep USDC on Kraken or in a self-custody wallet?"
    answer: "Keeping USDC on Kraken is simpler but means you rely on the exchange. A self-custody wallet (like MetaMask or Ledger) gives you full control but requires more technical responsibility. For beginners, Kraken is a reasonable starting point."
  - question: "Can I buy stablecoins from a high-inflation country like Turkey or Nigeria?"
    answer: "Kraken accepts users from many countries worldwide with standard identity verification. Check Kraken's supported countries list for your specific location before signing up."
---
...
For background on how stablecoins work, read [what are stablecoins](/what-are-stablecoins/).

## How to get started: step by step

### 1. Open an account on Kraken

<a target="_blank" rel="nofollow sponsored noopener" href="{{ site.kraken.affiliate_link }}">Kraken</a> is one of the oldest and most regulated exchanges in the world, licensed in Europe and the US, and accessible from most countries globally. It supports SEPA bank transfers and credit/debit card deposits.

You can use the referral code `{{ site.kraken.affiliate_code }}` when signing up.
...
For a full comparison, read [what is USDC](/what-is-usdc/) and [what is USDT](/what-is-usdt-tether/).
...
To get started, open your account at <a target="_blank" rel="nofollow sponsored noopener" href="{{ site.kraken.affiliate_link }}">Kraken</a>.
...
For a detailed comparison, see [what is USDC](/what-is-usdc/) and [what is USDT](/what-is-usdt-tether/).
...
If you want to start protecting your savings from inflation, <a target="_blank" rel="nofollow sponsored noopener" href="{{ site.kraken.affiliate_link }}">Kraken</a> is the most accessible regulated exchange for international users.
